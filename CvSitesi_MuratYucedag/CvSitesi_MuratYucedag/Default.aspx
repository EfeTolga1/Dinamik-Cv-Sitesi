<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CvSitesi_MuratYucedag.Default" %>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Efe Tolga</a></h1>
            <p class="top_hdp mt-2">Yazılım Gelistirici</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat ="server">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" placeholher="Mesajınız" TextMode="MultiLine" Height="50"></asp:TextBox>
